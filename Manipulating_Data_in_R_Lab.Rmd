...
# Part 1
1.  Read in the Wide Bike lanes data: Bike_Lanes_Wide.csv .  Name the data set `wide`.
...
`crash`: Manipulating_Data_in_R/lab/crashes.csv
`road`: Manipulating_Data_in_R/lab/roads.csv

```{r}
library(readr)
crashes <- read_csv("intro_R-main/data_manipulation/crashes.csv")
roads <- read_csv("intro_R-main/data_manipulation/roads.csv")
# view oder head 
```
...
# Part 3
8.  Read in the Bike lanes data: /data/Bike_Lanes.csv 
